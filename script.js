...
console.log("My name is Chloe");

//3. Store your age as a variable called "myAge"
var myAge = 19;

//4. Print to the console how old you will be in 5 years
console.log("In 5 years I will be " + (myAge + 5) + " years old.");

//5. Store your favorite food as a variable called "myFavoriteFood"
var myFavoriteFood = ("Ravioli");

//6. Publish your favorite food to `index.html` using `console.log()`
